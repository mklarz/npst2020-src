<script lang="ts">import Email from "./apps/email.svelte";
...
import { apps, kernelPanic, loading, background, servicePack, snowing, } from "./store";
;
...
$: availableApps = startMenuApps.filter((s) => (s.requireSP || 0) <= $servicePack);
</script>
